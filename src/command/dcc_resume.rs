...
impl DccResumeMessage {
    ...
    fn send_message_to(
        ...
        let _ = channel;
        let chat = DccResume::new(self.msg.clone())?;
    ...
    pub fn format_message(&self, msg: DccResume) -> String {
        let _ = msg;
        format!(
            ":{} PRIVMSG {} dcc resume {} {} {} {} ",
